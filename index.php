...
<!--===============================================================================================-->
    <link rel="icon" type="image/png" href="images/icons/title_img.png"/>
<!--===============================================================================================-->
...
<meta name="description" content="Tarun Acharya: Subscribe and get FREE updates about Covid-19 Cases including active cases, total cases, recovered cases and death cases across the Globe, India and Telangana everyday through SMS to your mobile.">
...
<meta itemprop="name" content="Get Covid Updates">
...
<meta name="image" property="og:image" itemprop="image" content="http://covidsms.2bz.in/images/wallpaper.jpg">
...
<meta name="twitter:image" content="http://covidsms.2bz.in/images/wallpaper.jpg">
...
<body>
	...
	<div class="contact1">
		...
		<div class="container-contact1">
		    <marquee behavior="scroll" direction="left">Subscribe and get FREE updates of the covid cases across the Globe, India and Telangana everyday at <strong>10:30 AM</strong>.</marquee>
			<div class="contact1-pic js-tilt" data-tilt>
				<img src="images/img-01.png" alt="IMG">
			</div>

			<form class="contact1-form validate-form" action="recaptcha.php" method="post">
				...
				<div class="wrap-input1 validate-input" data-validate = "Phone number is required">
					<input class="input1" type="tel" pattern="[0-9]{10}" maxlength="10" name="number" placeholder="Phone number" required>
					<span class="shadow-input1"></span>
				</div>
                <div style="padding-left: 10%;padding-bottom: 2%;padding-top: 2% " class="g-recaptcha" data-sitekey=""></div>
				...
				<p align="center" style="padding-top: 5%">For queries: 
			<a href="mailto:tarunkodakandla@gmail.com">tarunkodakandla@gmail.com</a></p>
			</form>
		</div>
	</div>
